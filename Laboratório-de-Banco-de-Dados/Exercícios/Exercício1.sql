...
nm_pais         VARCHAR2(40),
id_regiao       NUMBER,
CONSTRAINT ph_id_pais PRIMARY KEY (id_pais));

ALTER TABLE tb_pais
ADD ( CONSTRAINT fk_regiao_pais
    FOREIGN KEY (id_regiao) REFERENCES tb_regiao(id_regiao));
    
ALTER TABLE tb_pais DROP CONSTRAINT ph_id_pais;

ALTER TABLE tb_pais ADD CONSTRAINT pk_id_pais PRIMARY KEY(id_pais);
...
id_funcao           VARCHAR(10) CONSTRAINT nn_emp_funcao NOT NULL,
salario             NUMBER(8,2),
...
data_termino        DATE CONSTRAINT nn_hist_emp_dt_temino NOT NULL,
id_funcao           VARCHAR2(10) CONSTRAINT nn_hist_emp_id_funcao NOT NULL,
id_departamento     NUMBER(4),
CONSTRAINT ck_histo_emp_data_intervalo CHECK (data_termino > data_inicio)); 
...
ADD(CONSTRAINT pk_hist_emp_id_emp
    ...
    CONSTRAINT fk_histo_funcao_funcao
