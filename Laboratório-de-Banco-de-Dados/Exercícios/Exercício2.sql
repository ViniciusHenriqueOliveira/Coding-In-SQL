...
VALUES(100,'Steven','King','SKING','515.123.4567',TO_DATE('17-JUN-1987','dd-MON-yyyy')
,'AD_PRES',24000.00,NULL,NULL,90);

INSERT INTO tb_empregado
VALUES(101,'Neena','Kochhar','NKOCHHAR','515.123.4568',TO_DATE('21-SET-1989','dd-MON-yyyy')
,'AD_VP',17000.00,NULL,100,90);

INSERT INTO tb_empregado
VALUES(102,'Lex','De Haan','LDEHAAN','515.123.4569',TO_DATE('13-JAN-1993','dd-MON-yyyy')
,'AD_VP',17000.00,NULL,100,90);

INSERT INTO tb_empregado
VALUES(103,'Alexander','Hunold','AHUNOLD','590.423.4567',TO_DATE('03-JAN-1990','dd-MON-yyyy')
,'IT_PROG',9000.00,NULL,102,60);

INSERT INTO tb_empregado
VALUES(104,'Bruce','Ernst','BERNST','590.423.4568',TO_DATE('21-MAI-1991','dd-MON-yyyy')
,'IT_PROG',6000.00,NULL,103,60);

INSERT INTO tb_empregado
VALUES(105,'David','Austin','DAUSTIN','590.423.4569',TO_DATE('25-JUN-1997','dd-MON-yyyy')
,'IT_PROG',4800.00,NULL,103,60);

INSERT INTO tb_empregado
VALUES(106,'Valli','Pataballa','VPATABAL','590.423.4560',TO_DATE('05-FEV-1998','dd-MON-yyyy')
,'IT_PROG',4800.00,NULL,103,60);

INSERT INTO tb_empregado
VALUES(107,'Diana','Lorentz','DLORENTZ','590.423.5567',TO_DATE('07-FEV-1999','dd-MON-yyyy')
...
VALUES (102,TO_DATE('13-JAN-1993', 'dd-MON-yyyy')
,TO_DATE('24-JUL-1998', 'dd-MON-yyyy'),'IT_PROG',60);

INSERT INTO tb_historico_funcao
VALUES(101,TO_DATE('21-SET-1989', 'dd-MON-yyyy')
,TO_DATE('27-OUT-1993', 'dd-MON-yyyy'),'AC_ACCOUNT',110);

INSERT INTO tb_historico_funcao
VALUES (101,TO_DATE('28-OUT-1993', 'dd-MON-yyyy')
,TO_DATE('15-MAR-1997', 'dd-MON-yyyy'),'AC_MGR',110);

INSERT INTO tb_historico_funcao
VALUES (201,TO_DATE('17-FEV-1996', 'dd-MON-yyyy')
,TO_DATE('19-DEZ-1999', 'dd-MON-yyyy'),'MK_REP',20);

INSERT INTO tb_historico_funcao
VALUES (114,TO_DATE('24-MAR-1998', 'dd-MON-yyyy')
,TO_DATE('31-DEZ-1999', 'dd-MON-yyyy'),'ST_CLERK',50);

INSERT INTO tb_historico_funcao
VALUES (122,TO_DATE('01-JAN-1999', 'dd-MON-yyyy')
,TO_DATE('31-DEZ-1999', 'dd-MON-yyyy'),'ST_CLERK',50);

INSERT INTO tb_historico_funcao
VALUES (200,TO_DATE('17-SET-1987', 'dd-MON-yyyy')
,TO_DATE('17-JUN-1993', 'dd-MON-yyyy'),'AD_ASST',90);

INSERT INTO tb_historico_funcao
VALUES (176,TO_DATE('24-MAR-1998', 'dd-MON-yyyy')
,TO_DATE('31-DEZ-1998', 'dd-MON-yyyy'),'SA_REP',80);

INSERT INTO tb_historico_funcao
VALUES (176,TO_DATE('01-JAN-1999', 'dd-MON-yyyy')
,TO_DATE('31-DEZ-1999', 'dd-MON-yyyy'),'SA_MAN',80);

INSERT INTO tb_historico_funcao
VALUES (200,TO_DATE('01-JUL-1994', 'dd-MON-yyyy')
,TO_DATE('31-DEZ-1998', 'dd-MON-yyyy'),'AC_ACCOUNT',90);
...
------ORA-02298: não é possível validar (EXERCICIOS.FK_GERENTE_DEPTO) - chaves mães não localizadas
